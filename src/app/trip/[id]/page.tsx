      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-6 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Sefer Detayları</h1>
              <p className="text-gray-600">Koltuk seçimi yapın ve yolculuğunuzu planlayın</p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-gray-700">{trip.fromCity}</div>
                ...
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    ...
                    <div className="text-lg font-semibold text-gray-700">{trip.toCity}</div>
                    <div className="text-sm text-gray-600">Ertesi gün</div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl">
              ...
              <div>
                <div className="font-semibold text-gray-900">Klimalı</div>
                <div className="text-sm text-gray-600">Konforlu yolculuk</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Ücretsiz internet</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-xl">
              ...
              <div>
                <div className="font-semibold text-gray-900">{getAvailableSeatsCount()} Boş Koltuk</div>
                <div className="text-sm text-gray-600">41 koltuktan</div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border mb-4 overflow-x-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">Koltuk Durumları</h3>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div className="flex items-center gap-3">
                <div className="w-8 h-6 bg-white border-2 border-gray-300 rounded-md flex items-center justify-center text-xs font-medium">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-6 bg-green-500 border-2 border-green-600 rounded-md flex items-center justify-center">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-6 bg-blue-500 border-2 border-blue-600 rounded-md opacity-80 flex items-center justify-center">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-6 bg-blue-200 border-2 border-blue-400 rounded-md opacity-60 flex items-center justify-center">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-6 bg-pink-200 border-2 border-pink-400 rounded-md opacity-60 flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900">Seçiminizi Tamamlayın</h3>
                  <div className="text-sm text-gray-600">
                    <p className="mb-2">{selectedSeatIds.length} koltuk seçtiniz</p>
                      ...
                      {[...selectedSeatIds].sort((a, b) => a - b).map((seatId, index) => (
                        <div key={seatId} className="inline-flex items-center gap-1">
                          ...
                          <svg 
                            ...
                            <div 
                              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full w-4 h-4 flex items-center justify-center text-xs font-bold border shadow-sm"
                              style={{ 
                                borderColor: '#10B981',
              ...
              <div className="text-right">
                ...
                <button 
                  ...
                  className="mt-3 inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-colors shadow-sm"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
